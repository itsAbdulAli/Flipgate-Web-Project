<%@ Page Title="" Language="C#" MasterPageFile="~/buyerMasterPage.Master" AutoEventWireup="true" CodeBehind="BuyerHome.aspx.cs" Inherits="DB_PROJ.BuyerHome" %>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    ...
                                    <div class="product-price">
                                        ...
                                        <a class="btn" href="Listing.aspx"><i class="fa fa-shopping-cart"></i>Buy Now</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                           ...
                           <ItemTemplate>  
                            <asp:Label ID="SellerID_" runat="server" Text='<%#Eval("Userid") %>' Style="display:none" />
                            <asp:Label ID="SellerListingNo_" runat="server" Text='<%#Eval("sellerListingNo") %>' Style="display:none" />
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                    ...
                                    <div class="product-price">
                                        ...
                                        <a><asp:Button ID="Button" CssClass="btn" Text="Buy Now"  OnClick="ListingOpen" runat="server"/><i class="fa fa-shopping-cart"></i></a>
