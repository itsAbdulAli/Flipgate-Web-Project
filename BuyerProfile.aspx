<%@ Page Title="" Language="C#" MasterPageFile="~/buyerMasterPage.Master" AutoEventWireup="true" CodeBehind="BuyerProfile.aspx.cs" Inherits="DB_PROJ.WebForm4" %>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                             ...
                                             <ItemTemplate>  
                                                ...
                                                <td><asp:Label ID="Date_of_Purchase" runat="server" Text='<%#converttodate(Convert.ToString(Eval("date_of_deal"))) %>'></asp:Label></td>
                                                <td><asp:Label ID="Price" runat="server" Text='<%#Eval("Price") %>'></asp:Label></td>
                                                <td><asp:Label ID="Status" runat="server" Text="Owned"></asp:Label></td>
                                                </tr>
                                             </ItemTemplate>  
                                             <FooterTemplate> 
                                          ...
                                          <%--  <tr>
                                                <td><asp:Label ID="P1" runat="server" Text="1"></asp:Label></td>
                                                <td><asp:Label ID="PN1" runat="server" Text="Listing Name"></asp:Label></td>
                                                <td><asp:Label ID="D1" runat="server" Text="Date of Purchase"></asp:Label></td>
                                                <td><asp:Label ID="C1" runat="server" Text="Cost"></asp:Label></td>
                                                <td><asp:Label ID="S1" runat="server" Text="Status"></asp:Label></td>
                                                <td><asp:Button ID="Button1" CssClass="btn" runat="server" Text="Button" /></td>
                                            </tr>
                                            <tr>
                                                 <td><asp:Label ID="P2" runat="server" Text="2"></asp:Label></td>
                                                <td><asp:Label ID="PN2" runat="server" Text="Listing Name"></asp:Label></td>
                                                <td><asp:Label ID="D2" runat="server" Text="Date of Purchase"></asp:Label></td>
                                                <td><asp:Label ID="C2" runat="server" Text="Cost"></asp:Label></td>
                                                <td><asp:Label ID="S2" runat="server" Text="Status"></asp:Label></td>
                                                <td><asp:Button ID="Button2" CssClass="btn" runat="server" Text="Button" /></td>
                                            </tr>
                                            <tr>
                                                  <td><asp:Label ID="P3" runat="server" Text="3"></asp:Label></td>
                                                <td><asp:Label ID="PN3" runat="server" Text="Listing Name"></asp:Label></td>
                                                <td><asp:Label ID="D3" runat="server" Text="Date of Purchase"></asp:Label></td>
                                                <td><asp:Label ID="C3" runat="server" Text="Cost"></asp:Label></td>
                                                <td><asp:Label ID="S3" runat="server" Text="Status"></asp:Label></td>
                                                <td><asp:Button ID="Button3" CssClass="btn" runat="server" Text="Button" /></td>
                                            </tr>--%>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="tab-pane fade show active" id="account-tab" role="tabpanel" aria-labelledby="account-nav">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                         ...
                                         <asp:TextBox ID="AccEmail" ReadOnly="true" CssClass="form-control" Text ="EmailId" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-md-6">
                                         <label>Date of Birth</label>
                                         <asp:TextBox ID="AccDOB" ReadOnly="true" CssClass="form-control" Text ="Date Of Birth" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                         ...
                                         <asp:TextBox ID="PrevPassword"  ReadOnly="true" CssClass="form-control" Text ="Password" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-md-6"> 
